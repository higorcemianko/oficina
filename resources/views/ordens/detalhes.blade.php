...
<div class="container">
	...
	<table class="table table-striped table-bordered table-hover" style="width:100%" >
		...
		<tr style="background-color:#DCDCDC">
			<th>
				<a href="/ordensitens/lista/{{$ordem->id}}" class="btn btn-primary">Itens </a>
				<a href="/ordensservicos/lista/{{$ordem->id}}" class="btn btn-primary">Serviços </a>
				<a href="{{action('OrdemController@enviaEmail',$ordem->id)}}" class="btn btn-primary">Enviar E-mail </a>
			</th>
